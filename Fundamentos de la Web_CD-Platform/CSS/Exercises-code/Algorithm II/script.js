...
function printSumArray(x) {
  ...
  for (var i = 0; i < x.length; i++) {
    sum += x[i];
    console.log("Numero: " + i + " ,suma Array: " + sum);
  }
  return "Total: " + sum;
}
