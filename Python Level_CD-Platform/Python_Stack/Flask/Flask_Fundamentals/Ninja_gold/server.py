...
def process():
    ...
    if request.form['building'] == 'farm':
        ...
        session['message'].append(
            f"<p class='earned'>Earned { gold } golds from the { request.form['building'] }! ( {timestamp} )</p>")
    ...
    if request.form['building'] == 'casino':
        ...
        if gold >= 0:
            ...
            session['message'].append(
                f"<p class='lost'>Lost { gold } golds from the { request.form['building'] }! Ouch!!! ( {timestamp} )</p>")
